// WindowsProject7.cpp : 定义应用程序的入口点。
//
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_ABOUT:
            {
                ...
                if (zmrbakFileSaveDialog.ShowDialog(hWnd))
                {
                    DWORD selectedItemIndex = zmrbakFileSaveDialog.selectedItemIndex;
                    LPWSTR fileName = zmrbakFileSaveDialog.fileName;
