...
namespace WpfNotepad.ViewModels
{
    public class FileViewModel
    {
        ...
        private void OnPageSettingCommand()
        {
            ...
            pageSettings.PaperSize = new System.Drawing.Printing.PaperSize() { RawKind = DocumentModel.PaperSizeRawKind };
            pageSettings.PaperSource = new System.Drawing.Printing.PaperSource() { RawKind = DocumentModel.PaperSourceRawKind };
            pageSettings.Landscape = DocumentModel.PaperLandscape;
            pageSettings.Margins = DocumentModel.PagerMargins;
            //DocumentModel.PaperHeader = "";
            //DocumentModel.PaperFooter = "";
            // new System.Drawing.Printing.Margins() 
            //{
            //    Left =100, Right = 110, Top = 120, Bottom = 130
            //};
            //+		PaperSize	{[PaperSize A5 Kind=A5 Height=827 Width=583]}	System.Drawing.Printing.PaperSize
            //+		PaperSource	{[PaperSource 纸盒 1 Kind=Custom]}	System.Drawing.Printing.PaperSource
            //		Landscape	true	bool
            //+		Margins	{[Margins Left=39 Right=43 Top=47 Bottom=51]}	System.Drawing.Printing.Margins
            ...
            {
                DocumentModel.PagerMargins = PrinterUnitConvert.Convert(pageSetupDialog.PageSettings.Margins, PrinterUnit.ThousandthsOfAnInch, PrinterUnit.HundredthsOfAMillimeter);
                DocumentModel.PaperLandscape = pageSetupDialog.PageSettings.Landscape;
                DocumentModel.PaperSourceRawKind = pageSetupDialog.PageSettings.PaperSource.RawKind;
                DocumentModel.PaperSizeRawKind = pageSetupDialog.PageSettings.PaperSize.RawKind;
                DocumentModel.PaperHeader = "";
                DocumentModel.PaperFooter = "";
